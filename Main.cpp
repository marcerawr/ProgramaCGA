...
void dibujaPantallaDeCarga() { //Para dibujar en la pantalla.
	...
	//Texto del estudio.
	Font.glPrint((2.2f / 640.0f)*infGame.glWidth, infGame.glWidth*0.0f, infGame.glHeight*0.03f, "Loading ...");
...
void dibujaPantallaDeIntroduccion() { //Para dibujar en la pantalla.
	...
	if (infGame.tiempoEstado < 150)
		Font.glPrint((2.2f / 640.0f)*infGame.glWidth, infGame.glWidth*0.15f, infGame.glHeight*0.48f, " A long time ago");
	else if (infGame.tiempoEstado >= 150 && infGame.tiempoEstado < 300)
		Font.glPrint((2.2f / 640.0f)*infGame.glWidth, infGame.glWidth*0.11f, infGame.glHeight*0.48f, "in a galaxy far away");
